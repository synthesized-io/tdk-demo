/*
NB. This is a simplified Pagila database schema (no partitioned tables, no custom enum types, no vector types).

This is done for purpose of simplifying the Synthesized TDK tutorial.
*/
