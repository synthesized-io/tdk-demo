...
asciinema rec -c "./run_demo.sh" --idle-time-limit=2 --overwrite generation_from_scratch.cast
...
asciinema rec -c "./run_demo.sh" --idle-time-limit=2 --overwrite generation.cast
