...
asciinema rec -c "./run_demo.sh" --idle-time-limit=1 --overwrite generation_from_scratch.cast
asciinema-agg --no-loop generation_from_scratch.cast generation_from_scratch.gif

export CONFIG_FILE=config_generation.tdk.yaml
export SPIN_DATABASES_UP="docker-compose -f docker-compose.yaml -f docker-compose-input-db.yaml run tdk"
asciinema rec -c "./run_demo.sh" --idle-time-limit=1 --overwrite generation.cast
asciinema-agg --no-loop generation.cast generation.gif
